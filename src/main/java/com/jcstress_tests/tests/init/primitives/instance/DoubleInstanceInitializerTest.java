 ...
 * questions.
 */
package com.jcstress_tests.tests.init.primitives.instance;
...
import com.jcstress_tests.tests.init.Grading_DoubleCanSeeMost;
...
public class DoubleInstanceInitializerTest {
    ...
    public static class Shell {
        ...
        {
            x = Double.longBitsToDouble(0xFFFFFFFFFFFFFFFFL);
        }
    }
