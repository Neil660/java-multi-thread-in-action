 ...
 * questions.
 */
package com.jcstress_tests.tests.atomics.longs;
...
public class AtomicLongFieldUpdaterPairwiseTests {
    ...
    public static class AddAndGet_AddAndGet {
        @Actor
        public void actor1(S s, LongResult2 r) {
            r.r1 = s.u.addAndGet(s, 5);
        }

        @Actor
        public void actor2(S s, LongResult2 r) {
            r.r2 = s.u.addAndGet(s, 5);
        }
    }
    ...
    public static class AddAndGet_CAS {
        ...
        @Actor
        public void actor2(S s, LongResult2 r) {
            r.r2 = s.u.compareAndSet(s, 0, 20) ? 20 : 10;
        }
    }
    ...
    public static class CAS_CAS {
        @Actor
        public void actor1(S s, LongResult2 r) {
            r.r1 = s.u.compareAndSet(s, 0, 5) ? 5 : 1;
        }
    ...
    public static class WCAS_WCAS {
        @Actor
        public void actor1(S s, LongResult2 r) {
            r.r1 = s.u.weakCompareAndSet(s, 0, 5) ? 5 : 1;
        }
    ...
    public static class Set_Set {
        @Actor
        public void actor1(S s, LongResult1 r) {
            s.u.set(s, 5);
        }

        @Actor
        public void actor2(S s, LongResult1 r) {
            s.u.set(s, 10);
        }

        @Arbiter
        public void arbiter1(S s, LongResult1 r) {
            r.r1 = s.u.get(s);
        }
    }
}
