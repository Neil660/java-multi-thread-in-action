...
public class AtomicLongPairwiseTests {
    ...
    @Description("Tests pairwise operations on AtomicLong")
    ...
    public static class AddAndGet_CAS {
        ...
        @Actor
        public void actor2(S s, LongResult2 r) {
            r.r2 = s.compareAndSet(0, 20) ? 20 : 10;
        }
    }
    ...
    public static class WCAS_WCAS {
        @Actor
        public void actor1(S s, LongResult2 r) {
            r.r1 = s.weakCompareAndSet(0, 5) ? 5 : 1;
        }
