 ...
 * questions.
 */
package com.jcstress_tests.tests.locks.mutex;
...
import com.jcstress_tests.tests.locks.BothSucceed;
import com.jcstress_tests.tests.locks.NoOneSucceeds;
import com.jcstress_tests.tests.locks.OneSucceeds;
...
public class ReentrantLockMutexTests {
    ...
    public static class I_F {
        ...
        public static class LI_LI {
            @Actor
            public void actor1(I_F_State s, IntResult2 r) {
                r.r1 = s.LI();
            }

            @Actor
            public void actor2(I_F_State s, IntResult2 r) {
                r.r2 = s.LI();
            }
        }
    ...
    public static class I_N {
        ...
        public static class LI_LI {
            @Actor
            public void actor1(I_N_State s, IntResult2 r) {
                r.r1 = s.LI();
            }

            @Actor
            public void actor2(I_N_State s, IntResult2 r) {
                r.r2 = s.LI();
            }
        }
    ...
    public static class S_N {
        ...
        public static class LI_LI {
            @Actor
            public void actor1(S_N_State s, IntResult2 r) {
                r.r1 = s.LI();
            }

            @Actor
            public void actor2(S_N_State s, IntResult2 r) {
                r.r2 = s.LI();
            }
        }
    ...
    public static class S_F {
        ...
        public static class LI_LI {
            @Actor
            public void actor1(S_F_State s, IntResult2 r) {
                r.r1 = s.LI();
            }

            @Actor
            public void actor2(S_F_State s, IntResult2 r) {
                r.r2 = s.LI();
            }
        }
