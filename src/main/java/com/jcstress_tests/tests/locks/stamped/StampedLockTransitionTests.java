 ...
 * questions.
 */
package com.jcstress_tests.tests.locks.stamped;
...
public class StampedLockTransitionTests {
    ...
    public static class OO_OO {
        ...
        public void actor1(S s, IntResult2 r) {
            r.r1 = s.optimistic_optimistic();
        }

        @Actor
        public void actor2(S s, IntResult2 r) {
            r.r2 = s.optimistic_optimistic();
        }
    }
    ...
    public static class RO_RO {
        @Actor
        public void actor1(S s, IntResult2 r) {
            r.r1 = s.read_optimistic();
        }

        @Actor
        public void actor2(S s, IntResult2 r) {
            r.r2 = s.read_optimistic();
        }
    }
    ...
    public static class WO_WO {
        @Actor
        public void actor1(S s, IntResult2 r) {
            r.r1 = s.write_optimistic();
        }

        @Actor
        public void actor2(S s, IntResult2 r) {
            r.r2 = s.write_optimistic();
        }
    }
